...
<head>
    ...
    <title>Departamentos con sus Empleados</title>
</head>

<body>
<!-- <div class="card-body">
    <input type="text" class="form-control card-header aligth-center" style="width:20rem; height: 5rem" id="search" placeholder="Escribe para buscar...">
    </div> -->
    ...
    <div class="card shadow p-3 mb-5 bg-body rounded">
        ...
        <h1 class="card-header">Departamentos con sus Empleados</h1>
